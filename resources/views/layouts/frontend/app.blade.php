    ...
    <div class="container">
        <div class="row">
            <div class="footer-logo">
                <img src="{{ asset('html_theme/hedone/assets/img/logo-white.png') }}" alt="footer logo"/>
            </div>
            ...
            <div class="footer-text">
                © We are <span class="footer-text-span">Hedone</span>. All rights reserved. 2017<br>Made by <span
                    class="footer-text-span">IG Design</span> in Kraljevo, Serbia
            </div>
        </div>
    </div>
</footer>
