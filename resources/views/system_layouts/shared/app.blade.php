...
<head>
    ...
    {!! Meta::tag('viewport', 'width=device-width, user-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0') !!}
    {!! Meta::tag('title', config('app.name', 'Laravel') . ' | Auth'  ) !!}
    <!-- META DETAILED -->
