        ...
        <div class="row">
            <div class="col-md-4 mb-5">
                <div class="card blog-post-card">
                    <img class="card-img-top" src="{{ URL::asset('frontend_professional/core/images/blog/blog-post-thumb-card-1.jpg')}}" alt="image">
                    <div class="card-body">
                        <h5 class="card-title">
            ...
            <div class="col-md-4 mb-5">
                <div class="card blog-post-card">
                    <img class="card-img-top" src="{{ URL::asset('frontend_professional/core/images/blog/blog-post-thumb-card-2.jpg')}}" alt="image">
                    <div class="card-body">
                        <h5 class="card-title">
                            <a class="theme-link" href="blog-post.html">
            ...
            <div class="col-md-4 mb-5">
                <div class="card blog-post-card">
                    <img class="card-img-top" src="{{ URL::asset('frontend_professional/core/images/blog/blog-post-thumb-card-3.jpg')}}" alt="image">
                    <div class="card-body">
                        <h5 class="card-title">
                            <a class="theme-link" href="blog-post.html">
