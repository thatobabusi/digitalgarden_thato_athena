        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-5">
                <div class="card project-card">
                    <div class="row no-gutters">
                        <div class="col-lg-4 card-img-holder">
                            <img src="{{ URL::asset('frontend_professional/core/images/project/project-2.jpg')}}" class="card-img" alt="image">
                        </div>
                        <div class="col-lg-8">
                            <div class="card-body">
                                <h5 class="card-title">
            ...
            <div class="col-md-6 mb-5">
                <div class="card project-card">
                    <div class="row no-gutters">
                        <div class="col-lg-4 card-img-holder">
                            <img src="{{ URL::asset('frontend_professional/core/images/project/project-3.jpg')}}" class="card-img" alt="image">
                        </div>
                        <div class="col-lg-8">
                            <div class="card-body">
            ...
            <div class="col-md-6 mb-5">
                <div class="card project-card">
                    <div class="row no-gutters">
                        <div class="col-lg-4 card-img-holder">
                            <img src="{{ URL::asset('frontend_professional/core/images/project/project-4.jpg')}}" class="card-img" alt="image">
                        </div>
                        <div class="col-lg-8">
                            <div class="card-body">
                                <h5 class="card-title"><a href="project.html" class="theme-link">Project Heading</a></h5>
