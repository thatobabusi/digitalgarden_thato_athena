...
<head>
    ...
    <!-- FontAwesome JS -->
    <script defer src="{{ URL::asset('frontend_professional/core/fontawesome/js/all.js') }}"></script>

    <!-- Plugin CSS -->
    <link href="{{ URL::asset('frontend_professional/core/plugins/tiny-slider/tiny-slider.css') }}" rel="stylesheet">

    <!-- THEME CSS -->
    {{--@include('system_layouts.frontend.partials.app.app_theme_styles')--}}

    <link href="{{ URL::asset('frontend_professional/core/css/theme.css') }}" id="theme-style" rel="stylesheet">
    {{--<link href="{{ URL::asset('frontend_professional/core/css/theme-1.css') }}" id="theme-style" rel="stylesheet">--}}
    ...
    <script src="https://use.fontawesome.com/2be56169bf.js"></script>
