                ...
                <div class="col-md-5">
                    ...
                    {{ Form::open(['route' => ['frontend.contact.submit'], 'method' => 'POST', 'id' => 'contactForm',
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 form-group {{ $errors->has('message') ? ' has-error with-errors' : '' }}">
                                {{--<textarea id="message" name="message" class="form-control" rows="5" required>*Message</textarea>--}}
                                {!! Form::textarea('message', old('message'), ['id' => 'message', 'rows' => 5, 'required' => 'required',
                                    'placeholder' => '*Message', 'class' => 'col-md-12']) !!}
    ...
    <div class="cta-big bg-primary dark">
        <div class="container">
            <div class="text-center">
                ...
                <a href="tel:0027814181395" class="btn btn-outline-white m-1 pill">
                    <i class="md-icon dp14 mr-2">phone</i><span>CALL</span>
                </a>
                <a href="mailto:{{config('mail.from.address', 'demo@demo.org')}}" class="btn btn-outline-white m-1 pill">
