<div class="row col-md-12">
    ...
    <div class="form-group col-md-6">
        ...
        <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}"
               type="text" name="title" id="title" value="{{ old('title',$blogPostTag->title) }}" required>
    ...
    <div class="form-group col-md-6">
        ...
        <input class="form-control {{ $errors->has('slug') ? 'is-invalid' : '' }}"
               type="text" name="slug" id="slug" value="{{ old('slug', $blogPostTag->slug) }}" required>
    ...
    <div class="form-group col-md-6">
        ...
        <input class="form-control {{ $errors->has('created_at') ? 'is-invalid' : '' }}"
               type="text" name="created_at" id="created_at" value="{{ old('created_at', $blogPostTag->created_at) }}" readonly>
    ...
    <div class="form-group col-md-6">
        ...
        <input class="form-control {{ $errors->has('updated_at') ? 'is-invalid' : '' }}"
               type="text" name="updated_at" id="updated_at" value="{{ old('updated_at', $blogPostTag->updated_at) }}" readonly>
