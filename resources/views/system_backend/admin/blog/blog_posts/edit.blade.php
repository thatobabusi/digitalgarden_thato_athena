    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.blog.update", [$blogPost->id]) }}" enctype="multipart/form-data">
                ...
                @include('system_backend.admin.image._upload_form')

                @include('system_backend.admin.blog.blog_posts._edit_form')
    ...
    <div class="card">
        ...
        <div class="tab-content">
            <div class="tab-pane" role="tabpanel" id="blog_post_author">
                @includeIf('system_backend.admin.users._view_form', ['user' => $blogPost->blogPostAuthor])
            </div>
            <div class="tab-pane" role="tabpanel" id="blog_post_categories">
                @includeIf('system_backend.admin.blog.blog_post_categories._view_form', ['blogPostCategory' => $blogPost->blogPostCategory])
            </div>
            <div class="tab-pane" role="tabpanel" id="blog_post_images">
                @includeIf('system_backend.admin.image._view_form', ['image' => $blogPost->blogPostImage()])
            </div>
            <div class="tab-pane" role="tabpanel" id="blog_post_tags">
                @includeIf('system_backend.admin.blog.blog_post_tags._view_list', ['blogPostTags' => $blogPost->blogPostTags])
            </div>
        </div>
    </div>
