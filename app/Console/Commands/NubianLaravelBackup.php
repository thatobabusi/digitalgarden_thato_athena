...
/**
 * Class NubianLaravelBackup
 *
 * @package App\Console\Commands
 */
class NubianLaravelBackup extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'nubian:backup';
     ...
     * @var string
     */
    protected $description = 'Does a backup of the dev environment folder.';
    ...
    {
        //$this->generateLogo();
        $this->warn('Starting Laravel Project Backups and Environment Analysis');
        $this->warn('');
        $this->call('backup:run');
        $this->warn('');
        $this->warn('Finished Laravel Project Backups and Environment Analysis');
    }
