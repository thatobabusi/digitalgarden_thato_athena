...
class NubianLaravelUnusedPackages extends Command
{
     ...
     * @var string
     */
    protected $signature = 'nubian:unused-packages';
     ...
     * @var string
     */
    protected $description = 'Does a check for unused composer packages in the project that might be slowing it down.';
    ...
    public function handle()
    {
        ...
        $this->warn('Starting Laravel Check for Unused Packages Analysis');
        $this->warn('');
        $this->warn( shell_exec('unused_scanner scanner_config.php') ); //$this->warn( shell_exec('unused_scanner scanner_config.php --memory-limit=2G') );
        $this->warn('');
        $this->warn('Finished Laravel Check for Unused Packages Analysis');
