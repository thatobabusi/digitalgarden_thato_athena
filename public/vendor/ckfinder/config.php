...
$config['licenseKey']  = '*S?U-*1**-L**D-*M**-*5**-E*Q*-2**H';
...
$config['resourceTypes'][] = [
    ...
    ods,odt,pdf,png,ppt,pptx,qt,ram,rar,rm,rmi,rmvb,rtf,sdc,swf,sxc,sxw,tar,tgz,tif,tiff,txt,vsd,wav,wma,wmv,xls,xlsx,zip',
    'deniedExtensions'  => '',
    'backend'           => 'default'
];
